...
import sensorpush_api.models
from sensorpush_api import rest
from sensorpush_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sensorpush_api.models, klass)
