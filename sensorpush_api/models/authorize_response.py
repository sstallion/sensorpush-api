...
class AuthorizeResponse(BaseModel):
    ...
    """
    authorization: Optional[StrictStr] = Field(default=None, description="JWT oAuth authorization code. Pass this code to the oauth/accesscode service to request an access token. The [jwt](https://jwt.io/) website has a useful jwt viewer.")
    __properties = ["authorization"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthorizeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthorizeResponse:
        """Create an instance of AuthorizeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthorizeResponse.parse_obj(obj)

        _obj = AuthorizeResponse.parse_obj({
