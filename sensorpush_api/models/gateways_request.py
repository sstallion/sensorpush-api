...
class GatewaysRequest(BaseModel):
    """
    Request object for gateways.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GatewaysRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GatewaysRequest:
        """Create an instance of GatewaysRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GatewaysRequest.parse_obj(obj)

        _obj = GatewaysRequest.parse_obj({
