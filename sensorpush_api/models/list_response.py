...
class ListResponse(object):
    ...
    @property
    def files(self):
        """Gets the files of this ListResponse.  # noqa: E501


        :return: The files of this ListResponse.  # noqa: E501
        :rtype: list[ReportListing]
        """
        return self._files

    @files.setter
    def files(self, files):
        """Sets the files of this ListResponse.


        :param files: The files of this ListResponse.  # noqa: E501
        :type: list[ReportListing]
        """
