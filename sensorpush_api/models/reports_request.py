...
class ReportsRequest(object):
    ...
    @property
    def path(self):
        """Gets the path of this ReportsRequest.  # noqa: E501

        The directory path to perform this operation.  # noqa: E501

        :return: The path of this ReportsRequest.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this ReportsRequest.

        The directory path to perform this operation.  # noqa: E501

        :param path: The path of this ReportsRequest.  # noqa: E501
        :type: str
        """
