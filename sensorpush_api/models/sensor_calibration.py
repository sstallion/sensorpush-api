...
class SensorCalibration(BaseModel):
    """
    Calibration settings  # noqa: E501
    """
    humidity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Humidity calibration")
    temperature: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Temperature calibration")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SensorCalibration:
        """Create an instance of SensorCalibration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SensorCalibration.parse_obj(obj)

        _obj = SensorCalibration.parse_obj({
