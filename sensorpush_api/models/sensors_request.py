...
class SensorsRequest(BaseModel):
    """
    Request object for sensors.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SensorsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SensorsRequest:
        """Create an instance of SensorsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SensorsRequest.parse_obj(obj)

        _obj = SensorsRequest.parse_obj({
