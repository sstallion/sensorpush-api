...
class TagsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagsRequest:
        """Create an instance of TagsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagsRequest.parse_obj(obj)

        _obj = TagsRequest.parse_obj({
