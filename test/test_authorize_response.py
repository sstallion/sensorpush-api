...
from sensorpush_api.models.authorize_response import AuthorizeResponse  # noqa: E501
...
class TestAuthorizeResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthorizeResponse:
        """Test AuthorizeResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorizeResponse`
        """
        model = AuthorizeResponse()  # noqa: E501
        if include_optional:
