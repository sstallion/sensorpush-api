...
from sensorpush_api.models.sensor_calibration import SensorCalibration  # noqa: E501

class TestSensorCalibration(unittest.TestCase):
    """SensorCalibration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SensorCalibration:
        """Test SensorCalibration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SensorCalibration`
        """
        model = SensorCalibration()  # noqa: E501
        if include_optional:
    ...
    def testSensorCalibration(self):
        """Test SensorCalibration"""
